...
<div>
    @if ($cek_siswa == 0 && !Auth::user()->hasRole('admin'))
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-6 text-right"><a href="{{ route('jurnal.tambah') }}"><button class="btn btn-sm btn-success">Tambah</button></a></div>
            </div>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ $item->link_dokumentasi }}" target="_blank"><button class="btn btn-sm btn-primary"><i class="fa fa-eye"></i>&nbsp;
                                    Lihat</button></a></td>
                        <td>
                            <a href="{{ route('jurnal.edit', ['idjurnal' => $item->id]) }}"><button class="btn btn-sm btn-info"><i class="fas fa-edit"></i>
                                    Edit</button>
                        </td>
                    </tr>
                    @endforeach
